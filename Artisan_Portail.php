...
<div class="conatiner-fluid " style="margin-top:75px;">
    <div class="row w-100">
        ...
        <div class="col-lg-6 text-center" id="login">
                    ...
                    <form onsubmit="return verifForm()" method="post" action="./user/index.php?action=login" >
            ...
            <div class="col-lg-6 text-center" id="signup" style="display: none;">
                          ...
                          <span class="about2">Welcome</span><br>
                    <span>Enter Your information please to access ^^</span><br><br>
                    <form  onsubmit="return verif()" method="post" action="./user/index.php?action=create">
                        <div class="container">
                            <div class="row">
                                <div class="col-6">
